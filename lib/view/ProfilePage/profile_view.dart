                  ...
                  children: [
                    ...
                    Container(
                      child: ListView.separated(
                        ...
                        shrinkWrap: true,
                        itemCount: patientSetting.length,
                        separatorBuilder: (context, index) => SizedBox(),
                        itemBuilder: (context, index) => ContainerSettingView(
                          data: patientSetting[index],
                        ),
                      ),
                    ),
                    SizedBox(height: 15),
                    Container(child:users=='Doctor'? Column(children: [Text(
                      'Training',
                      style: TextStyle(fontWeight: FontWeight.w600, fontSize: 16),
                    ),
                      Container(
                    ...
                    Container(
                      child: ListView.separated(
                        physics: NeverScrollableScrollPhysics(),
                        shrinkWrap: true,
                        itemCount: patientAboutUs.length,
                        separatorBuilder: (context, index) => SizedBox(),
                        itemBuilder: (context, index) => ContainerSettingView(
                          data: users == 'Patient'
                              ? patientAboutUs[index]
                              : doctorAboutUs[index],
                        ),
                      ),
                    ),
                    ...
                    Container(
                      child: ListView.separated(
                        physics: NeverScrollableScrollPhysics(),
                        shrinkWrap: true,
                        itemCount: patientOther.length,
                        separatorBuilder: (context, index) => SizedBox(),
                        itemBuilder: (context, index) => ContainerSettingView(
                          data: patientOther[index],
                        ),
                      ),
                    ),
                  ],
